(function () {
  ...
  function inputField(id, label, type) {
    return [
      ...
      '<input id="' + id + '" required type="' + type + '" class="h-11 rounded-lg border border-slate-200 bg-white px-3 text-sm text-slate-900 shadow-sm outline-none transition focus:border-teal-500 focus:ring-2 focus:ring-teal-100">',
      "</label>"
    ].join("");
  }
